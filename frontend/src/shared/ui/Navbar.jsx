...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top navigation bar */}
      <nav className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 safe-area-top">
      ...
      <motion.div
        ...
        className="fixed top-0 right-0 w-80 h-full bg-white dark:bg-slate-900 z-50 lg:hidden safe-area-top"
      >
        <div className="p-4">
          {/* Close button */}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700 safe-area-bottom lg:hidden z-30">
              ...
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-brand-500 rounded-full"
                    initial={false}
                    transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
                  />
                )}
