          ...
          <div className="card">
            ...
            {healthScore && (
              <motion.div
                ...
                className="mt-6 p-6 bg-gradient-to-br from-brand-50 to-accent-50 dark:from-brand-900/20 dark:to-accent-900/20 rounded-xl border border-brand-200 dark:border-brand-800"
              >
